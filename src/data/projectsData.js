...
export const projectsData = [
  {
    ...
    smallDescription: "AI-powered tool to summarize and chat with YouTube video transcripts.",
    technologies: ["React", "Node.js", "Express", "Google Gemini AI", "yt-dlp", "Docker"],
    liveDemoLink: "https://ytsubs.haguma.com/",
